...
function wpsm_testi_b_review() {
    ...
    border-radius: 4px;
    margin-left: 10px;
    text-decoration: none;" href="https://wpshopmart.com/plugins/testimonial-pro/" class="btn btn-primary" target="_blank" rel="noopener"><?php _e( 'Upgrade To Testimonial Pro Plugin', '' ); ?></a>
		</p>
	</div>
