	...
	text-decoration:none;
		...
		margin-right:10px;	
			...
			<div class="pro-button-div">
				<a class="btn btn-danger btn-lg " href="https://wpshopmart.com/plugins/testimonial-pro/" target="_blank">Check Pro Version</a><a class="btn btn-success btn-lg " href="http://demo.wpshopmart.com/testimonial-pro-demo/" target="_blank">Team Pro Demo</a>
			</div>				
		<?php
	}
