...
class Pro_Social_Featured_Media_Widget extends WP_Widget {
	 ...
	 ?>
		...
		<div class="progression-studios-social-icons-widget-container">
			...
			<ul class="progression-studios-social-widget">
				...
				<?php if($fb_share_pro): ?><li><a href="<?php echo esc_attr( $fb_share_pro ); ?>" target="_blank" class="facebook-pro"><i class="fa fa-facebook-official"></i></a></li><?php endif; ?>
	...
	function form($instance)
	{
		...
		<p>
			<label for="<?php echo $this->get_field_id('pro_main_text'); ?>"><?php esc_html_e( 'Text Field', 'zaser-progression' ); ?>:</label>			
		...
		<p>
			<label for="<?php echo $this->get_field_id('progression_studios_btn_text'); ?>"><?php esc_html_e( 'Button Text', 'zaser-progression' ); ?>:</label>
			<input class="widefat" style="width: 216px;" id="<?php echo $this->get_field_id('progression_studios_btn_text'); ?>" name="<?php echo $this->get_field_name('progression_studios_btn_text'); ?>" value="<?php echo $instance['progression_studios_btn_text']; ?>" />
		</p>
	
		<p>
			<label for="<?php echo $this->get_field_id('progression_studios_btn_link'); ?>"><?php esc_html_e( 'Button Link', 'zaser-progression' ); ?>:</label>
			<input class="widefat" style="width: 216px;" id="<?php echo $this->get_field_id('progression_studios_btn_link'); ?>" name="<?php echo $this->get_field_name('progression_studios_btn_link'); ?>" value="<?php echo $instance['progression_studios_btn_link']; ?>" />
		</p>
		

		
		<p>
			<label for="<?php echo $this->get_field_id('fb_share_pro'); ?>">Facebook <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('twttr_share_pro'); ?>">Twitter <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('mail_share_pro'); ?>"><?php esc_html_e( 'E-mail Address', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('goog_share_pro'); ?>">Google+ <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('lnkedin_share_pro'); ?>">LinkedIn <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('instagram_share_pro'); ?>">Instagram <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('tumblr_share_pro'); ?>">Tumblr <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('pintrst_share_pro'); ?>">Pinterest <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('utube_share_pro'); ?>">Youtube <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('android_share_pro'); ?>">Flickr <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('vimeo_share_pro'); ?>">Vimeo <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('soundcloud_share_pro'); ?>">Soundcloud <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('vine_share_pro'); ?>">Vine <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('snapchat_share_pro'); ?>">Snapchat <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('dribbble_share_pro'); ?>">Dribbble <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('vk_share_pro'); ?>">VK <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('houzz_share_pro'); ?>">Houzz <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('wordpress_share_pro'); ?>">WordPress <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('behance_share_pro'); ?>">BeHance <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('medium_share_pro'); ?>">Medium <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('trip_advisor_share_pro'); ?>">Trip Advisor <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('twitch_share_pro'); ?>">Twitch <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('yelp_share_pro'); ?>">Yelp <?php esc_html_e( 'Link', 'zaser-progression' ); ?>:</label>
