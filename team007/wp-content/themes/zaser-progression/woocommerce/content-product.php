...
<li <?php post_class(); ?>>
	...
	<div class="progression-studios-store-product-image-container <?php if( !$product->is_in_stock() ): ?>outofstock<?php endif; ?> <?php echo esc_attr( get_theme_mod('progression_studios_shop_index_transition', 'progression-studios-shop-image-no-effect') ); ?>">
