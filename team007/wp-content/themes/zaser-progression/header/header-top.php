<div id="zaser-progression-header-top" class="<?php echo esc_attr(get_theme_mod('progression_studios_mobile_top_bar_left', 'progression_studios_hide_top_left_bar')); ?> <?php echo esc_attr(get_theme_mod('progression_studios_mobile_top_bar_right', 'progression_studios_hide_top_left_right')); ?>">
