...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>	
	<div class="progression-studios-default-blog-index <?php echo esc_attr( get_theme_mod('progression_studios_blog_transition', 'progression-studios-blog-image-scale') ); ?>  <?php echo esc_attr( get_theme_mod('progression_studios_blog_layout') ); ?>">

		<?php if(has_post_thumbnail()): ?>
			<div class="progression-studios-feaured-image">
				<?php progression_studios_blog_link(); ?>
					<?php if (get_theme_mod( 'progression_studios_blog_image_size', 'progression-studios-blog-size-default') == 'progression-studios-blog-size-default') : ?><?php the_post_thumbnail('progression-studios-image'); ?><?php endif; ?>
					<?php if (get_theme_mod( 'progression_studios_blog_image_size') == 'progression-studios-blog-size-tall') : ?><?php the_post_thumbnail('progression-studios-image-tall'); ?><?php endif; ?>
					<?php if (get_theme_mod( 'progression_studios_blog_image_size') == 'progression-studios-blog-size-uncropped') : ?><?php the_post_thumbnail('progression-studios-image-uncropped'); ?><?php endif; ?>
				</a>
						...
						<div class="flexslider progression-studios-gallery">
					      <ul class="slides">
								...
								<li>
									...
									<?php endif; ?> 
									<?php if (get_theme_mod( 'progression_studios_blog_image_size', 'progression-studios-blog-size-default') == 'progression-studios-blog-size-default') : ?><?php echo wp_get_attachment_image( $attachment_id, 'progression-studios-image' ); ?><?php endif; ?>
									<?php if (get_theme_mod( 'progression_studios_blog_image_size') == 'progression-studios-blog-size-tall') : ?><?php echo wp_get_attachment_image( $attachment_id, 'progression-studios-image-tall' ); ?><?php endif; ?>
									<?php if (get_theme_mod( 'progression_studios_blog_image_size') == 'progression-studios-blog-size-uncropped') : ?><?php echo wp_get_attachment_image( $attachment_id, 'progression-studios-image-tall' ); ?><?php endif; ?>
									</a></li>
								<?php endforeach;  ?>
							</ul>
		...
		<div class="progression-blog-content">
			...
			<?php if ( 'post' == get_post_type() ) : ?>
				<div class="progression-author-meta">
					...
					<?php if (get_theme_mod( 'progression_studios_blog_meta_category_display') == 'true') : ?><span class="blog-meta-category-list"><?php echo esc_html__( 'In ', 'zaser-progression' )?> <?php the_category(', '); ?></span><?php endif; ?>
					<?php if (get_theme_mod( 'progression_studios_blog_meta_comment_display') == 'true') : ?><span class="blog-meta-comments"><?php echo esc_html__( 'with ', 'zaser-progression' )?> <?php comments_popup_link( '' . wp_kses( __( 'No comments', 'zaser-progression' ), true ) . '', wp_kses( __( '1 comment', 'zaser-progression' ), true), wp_kses( __( '% comments', 'zaser-progression' ), true ) ); ?></span><?php endif; ?>
				</div>
			<?php endif; ?>
